...
class GithubLink extends React.PureComponent {
  ...
  handleMouseEnter = () => this.setState({ color: '#AAA' });

  handleMouseLeave = () => this.setState({ color: '#AAA' });
  ...
  render() {
    ...
    return (
      <div style={styles.wrapper}>
        {this.props.link &&
          <a href={`https://github.com/MartinKilonzo/${this.props.link}`} role="button" title="GitHub" onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} fill={this.state.color} >
          <svg width="36" height="36" viewBox="0 0 24 24">
            <path
              fill={this.state.color} id="github-link" d="M12,2A10,10 0 0,0 2,12C2,16.42 4.87,20.17 8.84,21.5C9.34,21.58
